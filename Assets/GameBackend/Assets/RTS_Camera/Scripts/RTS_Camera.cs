...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public KeyCode rotateUpKey = KeyCode.C;
        public KeyCode rotateDownKey = KeyCode.V;
        ...
        private void Rotation()
        {
            ...
            if (useMouseRotation && Input.GetKey(mouseRotationKey))
            {
                ...
                m_Transform.Rotate(new Vector3(1,0,1), -MouseAxis.y * Time.deltaTime * mouseRotationSpeed, Space.World);
            }
        }
